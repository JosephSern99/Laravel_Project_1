...
<script>
	$(function(){
		...
		$("#previewjo").on("click", function() {
		 
		var urlprint = "/crm/CustomPages/Report/Default.aspx?parmreport=Z_ServiceOrder.rpt&parmname=svod_ServiceOrderID&parmid={!! $record->getKey() !!}&exportname={!! $record->svod_Name !!}";
	
		window.open(urlprint, "_blank", "ScrollBars=1");
